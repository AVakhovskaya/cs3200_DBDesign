...
public class UserJdbcDao {
    ...
    static final String PASSWORD = "Bluefish1";
    ...
    public Integer createUser(User user)
        ...
        statement.setString(6, user.getHandle());
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        // User adam = new User("Adam", "Smith", "adams", "invisiblehand", "http://bbc.in/30gXhI4","test");
        // User catherine = new User("Catherine", "Wood", "cathie", "bitcoinisbig", "https://ark-invest.com/","test1");
        //dao.createUser(adam);
        ...
        */
        ...
        User thomas = new User("Thomas", "Sowell", "thomas", "polymath", "http://www.tsowell.com/","test2");
